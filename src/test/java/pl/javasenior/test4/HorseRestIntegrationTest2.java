...
@IntegrationTest
@DirtiesContext
class HorseRestIntegrationTest2 {
    ...
    void addAndGetHorseTest() {
        ...
        Long dogId = postResponse.getBody();
        assertThat(dogId).isNotNull();

        //get
        ResponseEntity<Horse> getResponse = restTemplate.getForEntity(getBaseUrl() + "/" + dogId, Horse.class);
